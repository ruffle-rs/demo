 ...
 */var hm;function Pv(){if(hm)return Xl;hm=1;var s=Symbol.for("react.transitional.element"),i=Symbol.for("react.fragment");function u(o,f,m){var h=null;if(m!==void 0&&(h=""+m),f.key!==void 0&&(h=""+f.key),"key"in f){m={};for(var k in f)k!=="key"&&(m[k]=f[k])}else m=f;return f=m.ref,{$$typeof:s,type:o,key:h,ref:f!==void 0?f:null,props:m}}return Xl.Fragment=i,Xl.jsx=u,Xl.jsxs=u,Xl}var vm;function Iv(){return vm||(vm=1,$o.exports=Pv()),$o.exports}var q=Iv(),Go={exports:{}},K={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
...
`;return i}panic(i){var f;if(this.panicked)return;this.panicked=!0,this.hideSplashScreen();const u=i;if(i instanceof Error&&(i.name==="AbortError"||i.message.includes("AbortError")))return;if(i instanceof gs){const m=(f=this.loadedConfig)==null?void 0:f.openInNewTab,h=this.loadedConfig&&"url"in this.loadedConfig?new URL(this.loadedConfig.url,document.baseURI):void 0;if(m&&h){this.addOpenInNewTabMessage(m,h);return}i=i.cause}const o=Object.assign([],{stackIndex:-1,avmStackIndex:-1});if(o.push(`# Error Info
...
`}),i}get nodeName(){return"OBJECT"}get data(){return this.getAttribute("data")}set data(i){if(i){const u=document.createAttribute("data");u.value=i,this.attributes.setNamedItem(u)}else this.attributes.removeNamedItem("data")}static isInterdictable(i){var k,w,b;if(Ds(i)||i.getElementsByTagName("ruffle-object").length>0||i.getElementsByTagName("ruffle-embed").length>0)return!1;const u=(k=i.attributes.getNamedItem("data"))==null?void 0:k.value.toLowerCase(),o=((w=i.attributes.getNamedItem("type"))==null?void 0:w.value)??null,f=rp(i);let m;if(u){if(Rs(u))return Ss(i,"data"),!1;m=u}else if(f.movie){if(Rs(f.movie)){const _=i.querySelector("param[name='movie']");if(_){Ss(_,"value");const L=_.getAttribute("value");L&&i.setAttribute("data",L)}return!1}m=f.movie}else return!1;const h=(b=i.attributes.getNamedItem("classid"))==null?void 0:b.value.toLowerCase();return h===kb.toLowerCase()?!Array.from(i.getElementsByTagName("object")).some(Qa.isInterdictable)&&!Array.from(i.getElementsByTagName("embed")).some(Ka.isInterdictable):h?!1:bp(m,o)}static fromNativeObjectElement(i){const u=Ts("ruffle-object",Qa),o=document.createElement(u);for(const f of Array.from(i.getElementsByTagName("embed")))Ka.isInterdictable(f)&&f.remove();for(const f of Array.from(i.getElementsByTagName("object")))Qa.isInterdictable(f)&&f.remove();return zp(i,o),o}get height(){return this.getAttribute("height")||""}set height(i){this.setAttribute("height",i)}get width(){return this.getAttribute("width")||""}set width(i){this.setAttribute("width",i)}get type(){return this.getAttribute("type")||""}set type(i){this.setAttribute("type",i)}}class zs{constructor(i){if(this.__mimeTypes=[],this.__namedMimeTypes={},i)for(let u=0;u<i.length;u++)this.install(i[u])}install(i){const u=new xp(i),o=this.__mimeTypes.length;this.__mimeTypes.push(u),this.__namedMimeTypes[i.type]=u,this[u.type]=u,this[o]=u}item(i){return this.__mimeTypes[i>>>0]}namedItem(i){return this.__namedMimeTypes[i]}get length(){return this.__mimeTypes.length}[Symbol.iterator](){return this.__mimeTypes[Symbol.iterator]()}get[Symbol.toStringTag](){return"MimeTypeArray"}}class xp{constructor(i){this.__mimeType=i}get type(){return this.__mimeType.type}get description(){return this.__mimeType.description}get suffixes(){return this.__mimeType.suffixes}get enabledPlugin(){return this.__mimeType.enabledPlugin}get[Symbol.toStringTag](){return"MimeType"}}class iy extends zs{constructor(i,u,o){super(),this.name=i,this.description=u,this.filename=o}}class up{constructor(i){this.__plugins=[],this.__namedPlugins={};for(let u=0;u<i.length;u++)this.install(i[u])}install(i){const u=this.__plugins.length;this.__plugins.push(i),this.__namedPlugins[i.name]=i,this[i.name]=i,this[u]=i}item(i){return this.__plugins[i>>>0]}namedItem(i){return this.__namedPlugins[i]}refresh(){}[Symbol.iterator](){return this.__plugins[Symbol.iterator]()}get[Symbol.toStringTag](){return"PluginArray"}get length(){return this.__plugins.length}}const ct=new iy("Shockwave Flash","Shockwave Flash 32.0 r0","ruffle.js");ct.install({type:hp,description:"Shockwave Flash",suffixes:"spl",enabledPlugin:ct});ct.install({type:pp,description:"Shockwave Flash",suffixes:"swf",enabledPlugin:ct});ct.install({type:vp,description:"Shockwave Flash",suffixes:"swf",enabledPlugin:ct});ct.install({type:gp,description:"Shockwave Flash",suffixes:"swf",enabledPlugin:ct});function ry(s){if(navigator.plugins.namedItem("Shockwave Flash"))return;(!("install"in navigator.plugins)||!navigator.plugins.install)&&(Object.defineProperty(window,"PluginArray",{value:up}),Object.defineProperty(navigator,"plugins",{value:new up(navigator.plugins),writable:!1})),navigator.plugins.install(s),s.length>0&&(!("install"in navigator.mimeTypes)||!navigator.mimeTypes.install)&&(Object.defineProperty(window,"MimeTypeArray",{value:zs}),Object.defineProperty(window,"MimeType",{value:xp}),Object.defineProperty(navigator,"mimeTypes",{value:new zs(navigator.mimeTypes),writable:!1}));const u=navigator.mimeTypes;for(let o=0;o<s.length;o+=1)u.install(s[o])}function uy(s){let i=(ni==null?void 0:ni.href)??"";return!Nt&&"publicPath"in s&&s.publicPath!==null&&s.publicPath!==void 0&&(i=s.publicPath),i!==""&&!i.endsWith("/")&&(i+="/"),i}var sp;const ri=((sp=window.RufflePlayer)==null?void 0:sp.config)??{},oy=uy(ri)+"ruffle.js";let os,ss;function sy(){var s;return"favorFlash"in ri&&ri.favorFlash===!1?!1:(((s=navigator.plugins.namedItem("Shockwave Flash"))==null?void 0:s.filename)??"ruffle.js")!=="ruffle.js"}function Ep(){try{os=os??document.getElementsByTagName("object"),ss=ss??document.getElementsByTagName("embed");for(const s of Array.from(os))if(Qa.isInterdictable(s)){const i=Qa.fromNativeObjectElement(s);s.replaceWith(i)}for(const s of Array.from(ss))if(Ka.isInterdictable(s)){const i=Ka.fromNativeEmbedElement(s);s.replaceWith(i)}}catch(s){console.error(`Serious error encountered when polyfilling native Flash elements: ${s}`)}}let cs,fs;function jp(){cs=cs??document.getElementsByTagName("iframe"),fs=fs??document.getElementsByTagName("frame"),[cs,fs].forEach(s=>{for(const i of s){if(i.dataset.rufflePolyfilled!==void 0)continue;i.dataset.rufflePolyfilled="";const u=i.contentWindow,o=`Couldn't load Ruffle into ${i.tagName}[${i.src}]: `;try{u.document.readyState==="complete"&&op(u,o)}catch(f){Nt||console.warn(o+f)}i.addEventListener("load",()=>{op(u,o)},!1)}})}async function op(s,i){await new Promise(o=>{window.setTimeout(()=>{o()},100)});let u;try{if(u=s.document,!u)return}catch(o){Nt||console.warn(i+o);return}if(!(!Nt&&u.documentElement.dataset.ruffleOptout!==void 0)){if(Nt)s.RufflePlayer||(s.RufflePlayer={}),s.RufflePlayer.config={...ri,...s.RufflePlayer.config??{}};else if(!s.RufflePlayer){const o=u.createElement("script");o.setAttribute("src",oy),o.onload=()=>{s.RufflePlayer={},s.RufflePlayer.config=ri},u.head.appendChild(o)}}}function cy(){new MutationObserver(function(i){i.some(o=>Array.from(o.addedNodes).some(f=>["EMBED","OBJECT"].includes(f.nodeName)||f instanceof Element&&f.querySelector("embed, object")!==null))&&(Ep(),jp())}).observe(document,{childList:!0,subtree:!0})}function fy(){ry(ct)}function dy(){sy()||(Ep(),jp(),cy())}const ai={version:_n.versionNumber+"+"+_n.buildDate.substring(0,10),polyfill(){dy()},pluginPolyfill(){fy()},createPlayer(){const s=Ts("ruffle-player",Os);return document.createElement(s)},options:{}};function my(s,i={}){let u;window.RufflePlayer instanceof Em?u=window.RufflePlayer:(u=new Em(window.RufflePlayer),window.RufflePlayer=u),u.sources[s]=ai,ai.options=i,("polyfills"in u.config?u.config.polyfills:!0)!==!1&&ai.pluginPolyfill()}my("local");og.createRoot(document.getElementById("root")).render(q.jsx(ds.StrictMode,{children:q.jsx(hg,{ruffleBaseConfig:{autoplay:Xa.On,unmuteOverlay:li.Hidden,logLevel:Tr.Warn,letterbox:Ar.On,forceScale:!0,forceAlign:!0},allowSampleSwfs:!0,allowUrlLoading:!1})}));
