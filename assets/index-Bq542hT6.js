const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./ruffle_web-CAvzlq51.js","./ruffle-imports-CztXuSei.js","./ruffle_web-wasm_mvp-DymelmSG.js"])))=>i.map(i=>d[i]);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ap;function Hg(){if(ap)return $;ap=1;var s=Symbol.for("react.transitional.element"),i=Symbol.for("react.portal"),o=Symbol.for("react.fragment"),u=Symbol.for("react.strict_mode"),f=Symbol.for("react.profiler"),m=Symbol.for("react.consumer"),g=Symbol.for("react.context"),S=Symbol.for("react.forward_ref"),x=Symbol.for("react.suspense"),y=Symbol.for("react.memo"),_=Symbol.for("react.lazy"),O=Symbol.for("react.activity"),Z=Symbol.iterator;function X(v){return v===null||typeof v!="object"?null:(v=Z&&v[Z]||v["@@iterator"],typeof v=="function"?v:null)}var ae={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},I=Object.assign,He={};function Be(v,M,U){this.props=v,this.context=M,this.refs=He,this.updater=U||ae}Be.prototype.isReactComponent={},Be.prototype.setState=function(v,M){if(typeof v!="object"&&typeof v!="function"&&v!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,v,M,"setState")},Be.prototype.forceUpdate=function(v){this.updater.enqueueForceUpdate(this,v,"forceUpdate")};function ln(){}ln.prototype=Be.prototype;function Ae(v,M,U){this.props=v,this.context=M,this.refs=He,this.updater=U||ae}var re=Ae.prototype=new ln;re.constructor=Ae,I(re,Be.prototype),re.isPureReactComponent=!0;var rn=Array.isArray;function Xe(){}var G={H:null,A:null,T:null,S:null},Me=Object.prototype.hasOwnProperty;function D(v,M,U){var H=U.ref;return{$$typeof:s,type:v,key:M,ref:H!==void 0?H:null,props:U}}function F(v,M){return D(v.type,M,v.props)}function oe(v){return typeof v=="object"&&v!==null&&v.$$typeof===s}function De(v){var M={"=":"=0",":":"=2"};return"$"+v.replace(/[=:]/g,function(U){return M[U]})}var gn=/\/+/g;function Fe(v,M){return typeof v=="object"&&v!==null&&v.key!=null?De(""+v.key):M.toString(36)}function Hn(v){switch(v.status){case"fulfilled":return v.value;case"rejected":throw v.reason;default:switch(typeof v.status=="string"?v.then(Xe,Xe):(v.status="pending",v.then(function(M){v.status==="pending"&&(v.status="fulfilled",v.value=M)},function(M){v.status==="pending"&&(v.status="rejected",v.reason=M)})),v.status){case"fulfilled":return v.value;case"rejected":throw v.reason}}throw v}function E(v,M,U,H,J){var ee=typeof v;(ee==="undefined"||ee==="boolean")&&(v=null);var de=!1;if(v===null)de=!0;else switch(ee){case"bigint":case"string":case"number":de=!0;break;case"object":switch(v.$$typeof){case s:case i:de=!0;break;case _:return de=v._init,E(de(v._payload),M,U,H,J)}}if(de)return J=J(v),de=H===""?"."+Fe(v,0):H,rn(J)?(U="",de!=null&&(U=de.replace(gn,"$&/")+"/"),E(J,M,U,"",function(sl){return sl})):J!=null&&(oe(J)&&(J=F(J,U+(J.key==null||v&&v.key===J.key?"":(""+J.key).replace(gn,"$&/")+"/")+de)),M.push(J)),1;de=0;var un=H===""?".":H+":";if(rn(v))for(var qe=0;qe<v.length;qe++)H=v[qe],ee=un+Fe(H,qe),de+=E(H,M,U,ee,J);else if(qe=X(v),typeof qe=="function")for(v=qe.call(v),qe=0;!(H=v.next()).done;)H=H.value,ee=un+Fe(H,qe++),de+=E(H,M,U,ee,J);else if(ee==="object"){if(typeof v.then=="function")return E(Hn(v),M,U,H,J);throw M=String(v),Error("Objects are not valid as a React child (found: "+(M==="[object Object]"?"object with keys {"+Object.keys(v).join(", ")+"}":M)+"). If you meant to render a collection of children, use an array instead.")}return de}function q(v,M,U){if(v==null)return v;var H=[],J=0;return E(v,H,"","",function(ee){return M.call(U,ee,J++)}),H}function Q(v){if(v._status===-1){var M=v._result;M=M(),M.then(function(U){(v._status===0||v._status===-1)&&(v._status=1,v._result=U)},function(U){(v._status===0||v._status===-1)&&(v._status=2,v._result=U)}),v._status===-1&&(v._status=0,v._result=M)}if(v._status===1)return v._result.default;throw v._result}var be=typeof reportError=="function"?reportError:function(v){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var M=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof v=="object"&&v!==null&&typeof v.message=="string"?String(v.message):String(v),error:v});if(!window.dispatchEvent(M))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",v);return}console.error(v)},Se={map:q,forEach:function(v,M,U){q(v,function(){M.apply(this,arguments)},U)},count:function(v){var M=0;return q(v,function(){M++}),M},toArray:function(v){return q(v,function(M){return M})||[]},only:function(v){if(!oe(v))throw Error("React.Children.only expected to receive a single React element child.");return v}};return $.Activity=O,$.Children=Se,$.Component=Be,$.Fragment=o,$.Profiler=f,$.PureComponent=Ae,$.StrictMode=u,$.Suspense=x,$.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=G,$.__COMPILER_RUNTIME={__proto__:null,c:function(v){return G.H.useMemoCache(v)}},$.cache=function(v){return function(){return v.apply(null,arguments)}},$.cacheSignal=function(){return null},$.cloneElement=function(v,M,U){if(v==null)throw Error("The argument must be a React element, but you passed "+v+".");var H=I({},v.props),J=v.key;if(M!=null)for(ee in M.key!==void 0&&(J=""+M.key),M)!Me.call(M,ee)||ee==="key"||ee==="__self"||ee==="__source"||ee==="ref"&&M.ref===void 0||(H[ee]=M[ee]);var ee=arguments.length-2;if(ee===1)H.children=U;else if(1<ee){for(var de=Array(ee),un=0;un<ee;un++)de[un]=arguments[un+2];H.children=de}return D(v.type,J,H)},$.createContext=function(v){return v={$$typeof:g,_currentValue:v,_currentValue2:v,_threadCount:0,Provider:null,Consumer:null},v.Provider=v,v.Consumer={$$typeof:m,_context:v},v},$.createElement=function(v,M,U){var H,J={},ee=null;if(M!=null)for(H in M.key!==void 0&&(ee=""+M.key),M)Me.call(M,H)&&H!=="key"&&H!=="__self"&&H!=="__source"&&(J[H]=M[H]);var de=arguments.length-2;if(de===1)J.children=U;else if(1<de){for(var un=Array(de),qe=0;qe<de;qe++)un[qe]=arguments[qe+2];J.children=un}if(v&&v.defaultProps)for(H in de=v.defaultProps,de)J[H]===void 0&&(J[H]=de[H]);return D(v,ee,J)},$.createRef=function(){return{current:null}},$.forwardRef=function(v){return{$$typeof:S,render:v}},$.isValidElement=oe,$.lazy=function(v){return{$$typeof:_,_payload:{_status:-1,_result:v},_init:Q}},$.memo=function(v,M){return{$$typeof:y,type:v,compare:M===void 0?null:M}},$.startTransition=function(v){var M=G.T,U={};G.T=U;try{var H=v(),J=G.S;J!==null&&J(U,H),typeof H=="object"&&H!==null&&typeof H.then=="function"&&H.then(Xe,be)}catch(ee){be(ee)}finally{M!==null&&U.types!==null&&(M.types=U.types),G.T=M}},$.unstable_useCacheRefresh=function(){return G.H.useCacheRefresh()},$.use=function(v){return G.H.use(v)},$.useActionState=function(v,M,U){return G.H.useActionState(v,M,U)},$.useCallback=function(v,M){return G.H.useCallback(v,M)},$.useContext=function(v){return G.H.useContext(v)},$.useDebugValue=function(){},$.useDeferredValue=function(v,M){return G.H.useDeferredValue(v,M)},$.useEffect=function(v,M){return G.H.useEffect(v,M)},$.useEffectEvent=function(v){return G.H.useEffectEvent(v)},$.useId=function(){return G.H.useId()},$.useImperativeHandle=function(v,M,U){return G.H.useImperativeHandle(v,M,U)},$.useInsertionEffect=function(v,M){return G.H.useInsertionEffect(v,M)},$.useLayoutEffect=function(v,M){return G.H.useLayoutEffect(v,M)},$.useMemo=function(v,M){return G.H.useMemo(v,M)},$.useOptimistic=function(v,M){return G.H.useOptimistic(v,M)},$.useReducer=function(v,M,U){return G.H.useReducer(v,M,U)},$.useRef=function(v){return G.H.useRef(v)},$.useState=function(v){return G.H.useState(v)},$.useSyncExternalStore=function(v,M,U){return G.H.useSyncExternalStore(v,M,U)},$.useTransition=function(){return G.H.useTransition()},$.version="19.2.0",$}var lp;function Xs(){return lp||(lp=1,cs.exports=Hg()),cs.exports}var an=Xs();const Ms=$p(an);var fs={exports:{}},ai={},ds={exports:{}},ms={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var op;function Vg(){if(op)return on;op=1;var s=Xs();function i(x){var y="https://react.dev/errors/"+x;if(1<arguments.length){y+="?args[]="+encodeURIComponent(arguments[1]);for(var _=2;_<arguments.length;_++)y+="&args[]="+encodeURIComponent(arguments[_])}return"Minified React error #"+x+"; visit "+y+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function o(){}var u={d:{f:o,r:function(){throw Error(i(522))},D:o,C:o,L:o,m:o,X:o,S:o,M:o},p:0,findDOMNode:null},f=Symbol.for("react.portal");function m(x,y,_){var O=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:f,key:O==null?null:""+O,children:x,containerInfo:y,implementation:_}}var g=s.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function S(x,y){if(x==="font")return"";if(typeof y=="string")return y==="use-credentials"?y:""}return on.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=u,on.createPortal=function(x,y){var _=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!y||y.nodeType!==1&&y.nodeType!==9&&y.nodeType!==11)throw Error(i(299));return m(x,y,null,_)},on.flushSync=function(x){var y=g.T,_=u.p;try{if(g.T=null,u.p=2,x)return x()}finally{g.T=y,u.p=_,u.d.f()}},on.preconnect=function(x,y){typeof x=="string"&&(y?(y=y.crossOrigin,y=typeof y=="string"?y==="use-credentials"?y:"":void 0):y=null,u.d.C(x,y))},on.prefetchDNS=function(x){typeof x=="string"&&u.d.D(x)},on.preinit=function(x,y){if(typeof x=="string"&&y&&typeof y.as=="string"){var _=y.as,O=S(_,y.crossOrigin),Z=typeof y.integrity=="string"?y.integrity:void 0,X=typeof y.fetchPriority=="string"?y.fetchPriority:void 0;_==="style"?u.d.S(x,typeof y.precedence=="string"?y.precedence:void 0,{crossOrigin:O,integrity:Z,fetchPriority:X}):_==="script"&&u.d.X(x,{crossOrigin:O,integrity:Z,fetchPriority:X,nonce:typeof y.nonce=="string"?y.nonce:void 0})}},on.preinitModule=function(x,y){if(typeof x=="string")if(typeof y=="object"&&y!==null){if(y.as==null||y.as==="script"){var _=S(y.as,y.crossOrigin);u.d.M(x,{crossOrigin:_,integrity:typeof y.integrity=="string"?y.integrity:void 0,nonce:typeof y.nonce=="string"?y.nonce:void 0})}}else y==null&&u.d.M(x)},on.preload=function(x,y){if(typeof x=="string"&&typeof y=="object"&&y!==null&&typeof y.as=="string"){var _=y.as,O=S(_,y.crossOrigin);u.d.L(x,_,{crossOrigin:O,integrity:typeof y.integrity=="string"?y.integrity:void 0,nonce:typeof y.nonce=="string"?y.nonce:void 0,type:typeof y.type=="string"?y.type:void 0,fetchPriority:typeof y.fetchPriority=="string"?y.fetchPriority:void 0,referrerPolicy:typeof y.referrerPolicy=="string"?y.referrerPolicy:void 0,imageSrcSet:typeof y.imageSrcSet=="string"?y.imageSrcSet:void 0,imageSizes:typeof y.imageSizes=="string"?y.imageSizes:void 0,media:typeof y.media=="string"?y.media:void 0})}},on.preloadModule=function(x,y){if(typeof x=="string")if(y){var _=S(y.as,y.crossOrigin);u.d.m(x,{as:typeof y.as=="string"&&y.as!=="script"?y.as:void 0,crossOrigin:_,integrity:typeof y.integrity=="string"?y.integrity:void 0})}else u.d.m(x)},on.requestFormReset=function(x){u.d.r(x)},on.unstable_batchedUpdates=function(x,y){return x(y)},on.useFormState=function(x,y,_){return g.H.useFormState(x,y,_)},on.useFormStatus=function(){return g.H.useHostTransitionStatus()},on.version="19.2.0",on}var up;function Yg(){if(up)return ps.exports;up=1;function s(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(s)}catch(i){console.error(i)}}return s(),ps.exports=Vg(),ps.exports}/**
 * @license React
