const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./ruffle_web-CilRT4LN.js","./ruffle-imports-CztXuSei.js","./ruffle_web-wasm_mvp-DK2eV0ho.js"])))=>i.map(i=>d[i]);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Hm;function wg(){if(Hm)return K;Hm=1;var s=Symbol.for("react.transitional.element"),i=Symbol.for("react.portal"),o=Symbol.for("react.fragment"),u=Symbol.for("react.strict_mode"),f=Symbol.for("react.profiler"),m=Symbol.for("react.consumer"),g=Symbol.for("react.context"),R=Symbol.for("react.forward_ref"),x=Symbol.for("react.suspense"),w=Symbol.for("react.memo"),M=Symbol.for("react.lazy"),H=Symbol.iterator;function Z(h){return h===null||typeof h!="object"?null:(h=H&&h[H]||h["@@iterator"],typeof h=="function"?h:null)}var X={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},ne=Object.assign,le={};function xe(h,O,U){this.props=h,this.context=O,this.refs=le,this.updater=U||X}xe.prototype.isReactComponent={},xe.prototype.setState=function(h,O){if(typeof h!="object"&&typeof h!="function"&&h!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,h,O,"setState")},xe.prototype.forceUpdate=function(h){this.updater.enqueueForceUpdate(this,h,"forceUpdate")};function on(){}on.prototype=xe.prototype;function Ke(h,O,U){this.props=h,this.context=O,this.refs=le,this.updater=U||X}var je=Ke.prototype=new on;je.constructor=Ke,ne(je,xe.prototype),je.isPureReactComponent=!0;var ie=Array.isArray,P={H:null,A:null,T:null,S:null,V:null},Ge=Object.prototype.hasOwnProperty;function ye(h,O,U,_,F,ue){return U=ue.ref,{$$typeof:s,type:h,key:O,ref:U!==void 0?U:null,props:ue}}function _e(h,O){return ye(h.type,O,void 0,void 0,void 0,h.props)}function C(h){return typeof h=="object"&&h!==null&&h.$$typeof===s}function V(h){var O={"=":"=0",":":"=2"};return"$"+h.replace(/[=:]/g,function(U){return O[U]})}var re=/\/+/g;function Ee(h,O){return typeof h=="object"&&h!==null&&h.key!=null?V(""+h.key):O.toString(36)}function mn(){}function Ze(h){switch(h.status){case"fulfilled":return h.value;case"rejected":throw h.reason;default:switch(typeof h.status=="string"?h.then(mn,mn):(h.status="pending",h.then(function(O){h.status==="pending"&&(h.status="fulfilled",h.value=O)},function(O){h.status==="pending"&&(h.status="rejected",h.reason=O)})),h.status){case"fulfilled":return h.value;case"rejected":throw h.reason}}throw h}function nn(h,O,U,_,F){var ue=typeof h;(ue==="undefined"||ue==="boolean")&&(h=null);var W=!1;if(h===null)W=!0;else switch(ue){case"bigint":case"string":case"number":W=!0;break;case"object":switch(h.$$typeof){case s:case i:W=!0;break;case M:return W=h._init,nn(W(h._payload),O,U,_,F)}}if(W)return F=F(h),W=_===""?"."+Ee(h,0):_,ie(F)?(U="",W!=null&&(U=W.replace(re,"$&/")+"/"),nn(F,O,U,"",function(ot){return ot})):F!=null&&(C(F)&&(F=_e(F,U+(F.key==null||h&&h.key===F.key?"":(""+F.key).replace(re,"$&/")+"/")+W)),O.push(F)),1;W=0;var pn=_===""?".":_+":";if(ie(h))for(var Ae=0;Ae<h.length;Ae++)_=h[Ae],ue=pn+Ee(_,Ae),W+=nn(_,O,U,ue,F);else if(Ae=Z(h),typeof Ae=="function")for(h=Ae.call(h),Ae=0;!(_=h.next()).done;)_=_.value,ue=pn+Ee(_,Ae++),W+=nn(_,O,U,ue,F);else if(ue==="object"){if(typeof h.then=="function")return nn(Ze(h),O,U,_,F);throw O=String(h),Error("Objects are not valid as a React child (found: "+(O==="[object Object]"?"object with keys {"+Object.keys(h).join(", ")+"}":O)+"). If you meant to render a collection of children, use an array instead.")}return W}function E(h,O,U){if(h==null)return h;var _=[],F=0;return nn(h,_,"","",function(ue){return O.call(U,ue,F++)}),_}function q(h){if(h._status===-1){var O=h._result;O=O(),O.then(function(U){(h._status===0||h._status===-1)&&(h._status=1,h._result=U)},function(U){(h._status===0||h._status===-1)&&(h._status=2,h._result=U)}),h._status===-1&&(h._status=0,h._result=O)}if(h._status===1)return h._result.default;throw h._result}var Q=typeof reportError=="function"?reportError:function(h){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var O=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof h=="object"&&h!==null&&typeof h.message=="string"?String(h.message):String(h),error:h});if(!window.dispatchEvent(O))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",h);return}console.error(h)};function we(){}return K.Children={map:E,forEach:function(h,O,U){E(h,function(){O.apply(this,arguments)},U)},count:function(h){var O=0;return E(h,function(){O++}),O},toArray:function(h){return E(h,function(O){return O})||[]},only:function(h){if(!C(h))throw Error("React.Children.only expected to receive a single React element child.");return h}},K.Component=xe,K.Fragment=o,K.Profiler=f,K.PureComponent=Ke,K.StrictMode=u,K.Suspense=x,K.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=P,K.__COMPILER_RUNTIME={__proto__:null,c:function(h){return P.H.useMemoCache(h)}},K.cache=function(h){return function(){return h.apply(null,arguments)}},K.cloneElement=function(h,O,U){if(h==null)throw Error("The argument must be a React element, but you passed "+h+".");var _=ne({},h.props),F=h.key,ue=void 0;if(O!=null)for(W in O.ref!==void 0&&(ue=void 0),O.key!==void 0&&(F=""+O.key),O)!Ge.call(O,W)||W==="key"||W==="__self"||W==="__source"||W==="ref"&&O.ref===void 0||(_[W]=O[W]);var W=arguments.length-2;if(W===1)_.children=U;else if(1<W){for(var pn=Array(W),Ae=0;Ae<W;Ae++)pn[Ae]=arguments[Ae+2];_.children=pn}return ye(h.type,F,void 0,void 0,ue,_)},K.createContext=function(h){return h={$$typeof:g,_currentValue:h,_currentValue2:h,_threadCount:0,Provider:null,Consumer:null},h.Provider=h,h.Consumer={$$typeof:m,_context:h},h},K.createElement=function(h,O,U){var _,F={},ue=null;if(O!=null)for(_ in O.key!==void 0&&(ue=""+O.key),O)Ge.call(O,_)&&_!=="key"&&_!=="__self"&&_!=="__source"&&(F[_]=O[_]);var W=arguments.length-2;if(W===1)F.children=U;else if(1<W){for(var pn=Array(W),Ae=0;Ae<W;Ae++)pn[Ae]=arguments[Ae+2];F.children=pn}if(h&&h.defaultProps)for(_ in W=h.defaultProps,W)F[_]===void 0&&(F[_]=W[_]);return ye(h,ue,void 0,void 0,null,F)},K.createRef=function(){return{current:null}},K.forwardRef=function(h){return{$$typeof:R,render:h}},K.isValidElement=C,K.lazy=function(h){return{$$typeof:M,_payload:{_status:-1,_result:h},_init:q}},K.memo=function(h,O){return{$$typeof:w,type:h,compare:O===void 0?null:O}},K.startTransition=function(h){var O=P.T,U={};P.T=U;try{var _=h(),F=P.S;F!==null&&F(U,_),typeof _=="object"&&_!==null&&typeof _.then=="function"&&_.then(we,Q)}catch(ue){Q(ue)}finally{P.T=O}},K.unstable_useCacheRefresh=function(){return P.H.useCacheRefresh()},K.use=function(h){return P.H.use(h)},K.useActionState=function(h,O,U){return P.H.useActionState(h,O,U)},K.useCallback=function(h,O){return P.H.useCallback(h,O)},K.useContext=function(h){return P.H.useContext(h)},K.useDebugValue=function(){},K.useDeferredValue=function(h,O){return P.H.useDeferredValue(h,O)},K.useEffect=function(h,O,U){var _=P.H;if(typeof U=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return _.useEffect(h,O)},K.useId=function(){return P.H.useId()},K.useImperativeHandle=function(h,O,U){return P.H.useImperativeHandle(h,O,U)},K.useInsertionEffect=function(h,O){return P.H.useInsertionEffect(h,O)},K.useLayoutEffect=function(h,O){return P.H.useLayoutEffect(h,O)},K.useMemo=function(h,O){return P.H.useMemo(h,O)},K.useOptimistic=function(h,O){return P.H.useOptimistic(h,O)},K.useReducer=function(h,O,U){return P.H.useReducer(h,O,U)},K.useRef=function(h){return P.H.useRef(h)},K.useState=function(h){return P.H.useState(h)},K.useSyncExternalStore=function(h,O,U){return P.H.useSyncExternalStore(h,O,U)},K.useTransition=function(){return P.H.useTransition()},K.version="19.1.1",K}var Bm;function Ls(){return Bm||(Bm=1,ns.exports=wg()),ns.exports}var en=Ls();const Rs=Dp(en);var ts={exports:{}},ei={},as={exports:{}},ls={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Vm;function kg(){return Vm||(Vm=1,function(s){function i(E,q){var Q=E.length;E.push(q);e:for(;0<Q;){var we=Q-1>>>1,h=E[we];if(0<f(h,q))E[we]=q,E[Q]=h,Q=we;else break e}}function o(E){return E.length===0?null:E[0]}function u(E){if(E.length===0)return null;var q=E[0],Q=E.pop();if(Q!==q){E[0]=Q;e:for(var we=0,h=E.length,O=h>>>1;we<O;){var U=2*(we+1)-1,_=E[U],F=U+1,ue=E[F];if(0>f(_,Q))F<h&&0>f(ue,_)?(E[we]=ue,E[F]=Q,we=F):(E[we]=_,E[U]=Q,we=U);else if(F<h&&0>f(ue,Q))E[we]=ue,E[F]=Q,we=F;else break e}}return q}function f(E,q){var Q=E.sortIndex-q.sortIndex;return Q!==0?Q:E.id-q.id}if(s.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var m=performance;s.unstable_now=function(){return m.now()}}else{var g=Date,R=g.now();s.unstable_now=function(){return g.now()-R}}var x=[],w=[],M=1,H=null,Z=3,X=!1,ne=!1,le=!1,xe=!1,on=typeof setTimeout=="function"?setTimeout:null,Ke=typeof clearTimeout=="function"?clearTimeout:null,je=typeof setImmediate<"u"?setImmediate:null;function ie(E){for(var q=o(w);q!==null;){if(q.callback===null)u(w);else if(q.startTime<=E)u(w),q.sortIndex=q.expirationTime,i(x,q);else break;q=o(w)}}function P(E){if(le=!1,ie(E),!ne)if(o(x)!==null)ne=!0,Ge||(Ge=!0,Ee());else{var q=o(w);q!==null&&nn(P,q.startTime-E)}}var Ge=!1,ye=-1,_e=5,C=-1;function V(){return xe?!0:!(s.unstable_now()-C<_e)}function re(){if(xe=!1,Ge){var E=s.unstable_now();C=E;var q=!0;try{e:{ne=!1,le&&(le=!1,Ke(ye),ye=-1),X=!0;var Q=Z;try{n:{for(ie(E),H=o(x);H!==null&&!(H.expirationTime>E&&V());){var we=H.callback;if(typeof we=="function"){H.callback=null,Z=H.priorityLevel;var h=we(H.expirationTime<=E);if(E=s.unstable_now(),typeof h=="function"){H.callback=h,ie(E),q=!0;break n}H===o(x)&&u(x),ie(E)}else u(x);H=o(x)}if(H!==null)q=!0;else{var O=o(w);O!==null&&nn(P,O.startTime-E),q=!1}}break e}finally{H=null,Z=Q,X=!1}q=void 0}}finally{q?Ee():Ge=!1}}}var Ee;if(typeof je=="function")Ee=function(){je(re)};else if(typeof MessageChannel<"u"){var mn=new MessageChannel,Ze=mn.port2;mn.port1.onmessage=re,Ee=function(){Ze.postMessage(null)}}else Ee=function(){on(re,0)};function nn(E,q){ye=on(function(){E(s.unstable_now())},q)}s.unstable_IdlePriority=5,s.unstable_ImmediatePriority=1,s.unstable_LowPriority=4,s.unstable_NormalPriority=3,s.unstable_Profiling=null,s.unstable_UserBlockingPriority=2,s.unstable_cancelCallback=function(E){E.callback=null},s.unstable_forceFrameRate=function(E){0>E||125<E?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):_e=0<E?Math.floor(1e3/E):5},s.unstable_getCurrentPriorityLevel=function(){return Z},s.unstable_next=function(E){switch(Z){case 1:case 2:case 3:var q=3;break;default:q=Z}var Q=Z;Z=q;try{return E()}finally{Z=Q}},s.unstable_requestPaint=function(){xe=!0},s.unstable_runWithPriority=function(E,q){switch(E){case 1:case 2:case 3:case 4:case 5:break;default:E=3}var Q=Z;Z=E;try{return q()}finally{Z=Q}},s.unstable_scheduleCallback=function(E,q,Q){var we=s.unstable_now();switch(typeof Q=="object"&&Q!==null?(Q=Q.delay,Q=typeof Q=="number"&&0<Q?we+Q:we):Q=we,E){case 1:var h=-1;break;case 2:h=250;break;case 5:h=1073741823;break;case 4:h=1e4;break;default:h=5e3}return h=Q+h,E={id:M++,callback:q,priorityLevel:E,startTime:Q,expirationTime:h,sortIndex:-1},Q>we?(E.sortIndex=Q,i(w,E),o(x)===null&&E===o(w)&&(le?(Ke(ye),ye=-1):le=!0,nn(P,Q-we))):(E.sortIndex=h,i(x,E),ne||X||(ne=!0,Ge||(Ge=!0,Ee()))),E},s.unstable_shouldYield=V,s.unstable_wrapCallback=function(E){var q=Z;return function(){var Q=Z;Z=q;try{return E.apply(this,arguments)}finally{Z=Q}}}}(ls)),ls}var Fm;function Rg(){return Fm||(Fm=1,as.exports=kg()),as.exports}var is={exports:{}},ln={};/**
 * @license React
