const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./ruffle_web-DlM-0hM6.js","./ruffle-imports-CztXuSei.js","./ruffle_web-wasm_mvp-lEpokvC2.js"])))=>i.map(i=>d[i]);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Vm;function zg(){return Vm||(Vm=1,function(s){function i(j,q){var Q=j.length;j.push(q);e:for(;0<Q;){var Se=Q-1>>>1,h=j[Se];if(0<f(h,q))j[Se]=q,j[Q]=h,Q=Se;else break e}}function o(j){return j.length===0?null:j[0]}function u(j){if(j.length===0)return null;var q=j[0],Q=j.pop();if(Q!==q){j[0]=Q;e:for(var Se=0,h=j.length,O=h>>>1;Se<O;){var U=2*(Se+1)-1,_=j[U],F=U+1,ce=j[F];if(0>f(_,Q))F<h&&0>f(ce,_)?(j[Se]=ce,j[F]=Q,Se=F):(j[Se]=_,j[U]=Q,Se=U);else if(F<h&&0>f(ce,Q))j[Se]=ce,j[F]=Q,Se=F;else break e}}return q}function f(j,q){var Q=j.sortIndex-q.sortIndex;return Q!==0?Q:j.id-q.id}if(s.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var m=performance;s.unstable_now=function(){return m.now()}}else{var g=Date,k=g.now();s.unstable_now=function(){return g.now()-k}}var w=[],b=[],M=1,L=null,Y=3,I=!1,J=!1,ie=!1,ue=!1,qe=typeof setTimeout=="function"?setTimeout:null,Fe=typeof clearTimeout=="function"?clearTimeout:null,se=typeof setImmediate<"u"?setImmediate:null;function te(j){for(var q=o(b);q!==null;){if(q.callback===null)u(b);else if(q.startTime<=j)u(b),q.sortIndex=q.expirationTime,i(w,q);else break;q=o(b)}}function X(j){if(ie=!1,te(j),!J)if(o(w)!==null)J=!0,Ue||(Ue=!0,Ae());else{var q=o(b);q!==null&&tn(X,q.startTime-j)}}var Ue=!1,me=-1,ye=5,C=-1;function V(){return ue?!0:!(s.unstable_now()-C<ye)}function re(){if(ue=!1,Ue){var j=s.unstable_now();C=j;var q=!0;try{e:{J=!1,ie&&(ie=!1,Fe(me),me=-1),I=!0;var Q=Y;try{n:{for(te(j),L=o(w);L!==null&&!(L.expirationTime>j&&V());){var Se=L.callback;if(typeof Se=="function"){L.callback=null,Y=L.priorityLevel;var h=Se(L.expirationTime<=j);if(j=s.unstable_now(),typeof h=="function"){L.callback=h,te(j),q=!0;break n}L===o(w)&&u(w),te(j)}else u(w);L=o(w)}if(L!==null)q=!0;else{var O=o(b);O!==null&&tn(X,O.startTime-j),q=!1}}break e}finally{L=null,Y=Q,I=!1}q=void 0}}finally{q?Ae():Ue=!1}}}var Ae;if(typeof se=="function")Ae=function(){se(re)};else if(typeof MessageChannel<"u"){var mn=new MessageChannel,Qe=mn.port2;mn.port1.onmessage=re,Ae=function(){Qe.postMessage(null)}}else Ae=function(){qe(re,0)};function tn(j,q){me=qe(function(){j(s.unstable_now())},q)}s.unstable_IdlePriority=5,s.unstable_ImmediatePriority=1,s.unstable_LowPriority=4,s.unstable_NormalPriority=3,s.unstable_Profiling=null,s.unstable_UserBlockingPriority=2,s.unstable_cancelCallback=function(j){j.callback=null},s.unstable_forceFrameRate=function(j){0>j||125<j?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):ye=0<j?Math.floor(1e3/j):5},s.unstable_getCurrentPriorityLevel=function(){return Y},s.unstable_next=function(j){switch(Y){case 1:case 2:case 3:var q=3;break;default:q=Y}var Q=Y;Y=q;try{return j()}finally{Y=Q}},s.unstable_requestPaint=function(){ue=!0},s.unstable_runWithPriority=function(j,q){switch(j){case 1:case 2:case 3:case 4:case 5:break;default:j=3}var Q=Y;Y=j;try{return q()}finally{Y=Q}},s.unstable_scheduleCallback=function(j,q,Q){var Se=s.unstable_now();switch(typeof Q=="object"&&Q!==null?(Q=Q.delay,Q=typeof Q=="number"&&0<Q?Se+Q:Se):Q=Se,j){case 1:var h=-1;break;case 2:h=250;break;case 5:h=1073741823;break;case 4:h=1e4;break;default:h=5e3}return h=Q+h,j={id:M++,callback:q,priorityLevel:j,startTime:Q,expirationTime:h,sortIndex:-1},Q>Se?(j.sortIndex=Q,i(b,j),o(w)===null&&j===o(b)&&(ie?(Fe(me),me=-1):ie=!0,tn(X,Q-Se))):(j.sortIndex=h,i(w,j),J||I||(J=!0,Ue||(Ue=!0,Ae()))),j},s.unstable_shouldYield=V,s.unstable_wrapCallback=function(j){var q=Y;return function(){var Q=Y;Y=q;try{return j.apply(this,arguments)}finally{Y=Q}}}}(rs)),rs}var Ym;function xg(){return Ym||(Ym=1,is.exports=zg()),is.exports}var os={exports:{}},rn={};/**
 * @license React
