const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./ruffle_web-BNkPYHFm.js","./ruffle-imports-CztXuSei.js","./ruffle_web-wasm_mvp-Rg6sii35.js"])))=>i.map(i=>d[i]);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Hm;function Sg(){if(Hm)return K;Hm=1;var s=Symbol.for("react.transitional.element"),i=Symbol.for("react.portal"),o=Symbol.for("react.fragment"),u=Symbol.for("react.strict_mode"),f=Symbol.for("react.profiler"),m=Symbol.for("react.consumer"),g=Symbol.for("react.context"),k=Symbol.for("react.forward_ref"),w=Symbol.for("react.suspense"),b=Symbol.for("react.memo"),M=Symbol.for("react.lazy"),L=Symbol.iterator;function Y(h){return h===null||typeof h!="object"?null:(h=L&&h[L]||h["@@iterator"],typeof h=="function"?h:null)}var J={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},I=Object.assign,ie={};function re(h,O,U){this.props=h,this.context=O,this.refs=ie,this.updater=U||J}re.prototype.isReactComponent={},re.prototype.setState=function(h,O){if(typeof h!="object"&&typeof h!="function"&&h!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,h,O,"setState")},re.prototype.forceUpdate=function(h){this.updater.enqueueForceUpdate(this,h,"forceUpdate")};function Ue(){}Ue.prototype=re.prototype;function Me(h,O,U){this.props=h,this.context=O,this.refs=ie,this.updater=U||J}var se=Me.prototype=new Ue;se.constructor=Me,I(se,re.prototype),se.isPureReactComponent=!0;var te=Array.isArray,X={H:null,A:null,T:null,S:null,V:null},Ne=Object.prototype.hasOwnProperty;function me(h,O,U,_,F,ce){return U=ce.ref,{$$typeof:s,type:h,key:O,ref:U!==void 0?U:null,props:ce}}function ye(h,O){return me(h.type,O,void 0,void 0,void 0,h.props)}function C(h){return typeof h=="object"&&h!==null&&h.$$typeof===s}function V(h){var O={"=":"=0",":":"=2"};return"$"+h.replace(/[=:]/g,function(U){return O[U]})}var oe=/\/+/g;function Ae(h,O){return typeof h=="object"&&h!==null&&h.key!=null?V(""+h.key):O.toString(36)}function mn(){}function $e(h){switch(h.status){case"fulfilled":return h.value;case"rejected":throw h.reason;default:switch(typeof h.status=="string"?h.then(mn,mn):(h.status="pending",h.then(function(O){h.status==="pending"&&(h.status="fulfilled",h.value=O)},function(O){h.status==="pending"&&(h.status="rejected",h.reason=O)})),h.status){case"fulfilled":return h.value;case"rejected":throw h.reason}}throw h}function tn(h,O,U,_,F){var ce=typeof h;(ce==="undefined"||ce==="boolean")&&(h=null);var W=!1;if(h===null)W=!0;else switch(ce){case"bigint":case"string":case"number":W=!0;break;case"object":switch(h.$$typeof){case s:case i:W=!0;break;case M:return W=h._init,tn(W(h._payload),O,U,_,F)}}if(W)return F=F(h),W=_===""?"."+Ae(h,0):_,te(F)?(U="",W!=null&&(U=W.replace(oe,"$&/")+"/"),tn(F,O,U,"",function(ot){return ot})):F!=null&&(C(F)&&(F=ye(F,U+(F.key==null||h&&h.key===F.key?"":(""+F.key).replace(oe,"$&/")+"/")+W)),O.push(F)),1;W=0;var pn=_===""?".":_+":";if(te(h))for(var Te=0;Te<h.length;Te++)_=h[Te],ce=pn+Ae(_,Te),W+=tn(_,O,U,ce,F);else if(Te=Y(h),typeof Te=="function")for(h=Te.call(h),Te=0;!(_=h.next()).done;)_=_.value,ce=pn+Ae(_,Te++),W+=tn(_,O,U,ce,F);else if(ce==="object"){if(typeof h.then=="function")return tn($e(h),O,U,_,F);throw O=String(h),Error("Objects are not valid as a React child (found: "+(O==="[object Object]"?"object with keys {"+Object.keys(h).join(", ")+"}":O)+"). If you meant to render a collection of children, use an array instead.")}return W}function j(h,O,U){if(h==null)return h;var _=[],F=0;return tn(h,_,"","",function(ce){return O.call(U,ce,F++)}),_}function q(h){if(h._status===-1){var O=h._result;O=O(),O.then(function(U){(h._status===0||h._status===-1)&&(h._status=1,h._result=U)},function(U){(h._status===0||h._status===-1)&&(h._status=2,h._result=U)}),h._status===-1&&(h._status=0,h._result=O)}if(h._status===1)return h._result.default;throw h._result}var Q=typeof reportError=="function"?reportError:function(h){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var O=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof h=="object"&&h!==null&&typeof h.message=="string"?String(h.message):String(h),error:h});if(!window.dispatchEvent(O))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",h);return}console.error(h)};function Se(){}return K.Children={map:j,forEach:function(h,O,U){j(h,function(){O.apply(this,arguments)},U)},count:function(h){var O=0;return j(h,function(){O++}),O},toArray:function(h){return j(h,function(O){return O})||[]},only:function(h){if(!C(h))throw Error("React.Children.only expected to receive a single React element child.");return h}},K.Component=re,K.Fragment=o,K.Profiler=f,K.PureComponent=Me,K.StrictMode=u,K.Suspense=w,K.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=X,K.__COMPILER_RUNTIME={__proto__:null,c:function(h){return X.H.useMemoCache(h)}},K.cache=function(h){return function(){return h.apply(null,arguments)}},K.cloneElement=function(h,O,U){if(h==null)throw Error("The argument must be a React element, but you passed "+h+".");var _=I({},h.props),F=h.key,ce=void 0;if(O!=null)for(W in O.ref!==void 0&&(ce=void 0),O.key!==void 0&&(F=""+O.key),O)!Ne.call(O,W)||W==="key"||W==="__self"||W==="__source"||W==="ref"&&O.ref===void 0||(_[W]=O[W]);var W=arguments.length-2;if(W===1)_.children=U;else if(1<W){for(var pn=Array(W),Te=0;Te<W;Te++)pn[Te]=arguments[Te+2];_.children=pn}return me(h.type,F,void 0,void 0,ce,_)},K.createContext=function(h){return h={$$typeof:g,_currentValue:h,_currentValue2:h,_threadCount:0,Provider:null,Consumer:null},h.Provider=h,h.Consumer={$$typeof:m,_context:h},h},K.createElement=function(h,O,U){var _,F={},ce=null;if(O!=null)for(_ in O.key!==void 0&&(ce=""+O.key),O)Ne.call(O,_)&&_!=="key"&&_!=="__self"&&_!=="__source"&&(F[_]=O[_]);var W=arguments.length-2;if(W===1)F.children=U;else if(1<W){for(var pn=Array(W),Te=0;Te<W;Te++)pn[Te]=arguments[Te+2];F.children=pn}if(h&&h.defaultProps)for(_ in W=h.defaultProps,W)F[_]===void 0&&(F[_]=W[_]);return me(h,ce,void 0,void 0,null,F)},K.createRef=function(){return{current:null}},K.forwardRef=function(h){return{$$typeof:k,render:h}},K.isValidElement=C,K.lazy=function(h){return{$$typeof:M,_payload:{_status:-1,_result:h},_init:q}},K.memo=function(h,O){return{$$typeof:b,type:h,compare:O===void 0?null:O}},K.startTransition=function(h){var O=X.T,U={};X.T=U;try{var _=h(),F=X.S;F!==null&&F(U,_),typeof _=="object"&&_!==null&&typeof _.then=="function"&&_.then(Se,Q)}catch(ce){Q(ce)}finally{X.T=O}},K.unstable_useCacheRefresh=function(){return X.H.useCacheRefresh()},K.use=function(h){return X.H.use(h)},K.useActionState=function(h,O,U){return X.H.useActionState(h,O,U)},K.useCallback=function(h,O){return X.H.useCallback(h,O)},K.useContext=function(h){return X.H.useContext(h)},K.useDebugValue=function(){},K.useDeferredValue=function(h,O){return X.H.useDeferredValue(h,O)},K.useEffect=function(h,O,U){var _=X.H;if(typeof U=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return _.useEffect(h,O)},K.useId=function(){return X.H.useId()},K.useImperativeHandle=function(h,O,U){return X.H.useImperativeHandle(h,O,U)},K.useInsertionEffect=function(h,O){return X.H.useInsertionEffect(h,O)},K.useLayoutEffect=function(h,O){return X.H.useLayoutEffect(h,O)},K.useMemo=function(h,O){return X.H.useMemo(h,O)},K.useOptimistic=function(h,O){return X.H.useOptimistic(h,O)},K.useReducer=function(h,O,U){return X.H.useReducer(h,O,U)},K.useRef=function(h){return X.H.useRef(h)},K.useState=function(h){return X.H.useState(h)},K.useSyncExternalStore=function(h,O,U){return X.H.useSyncExternalStore(h,O,U)},K.useTransition=function(){return X.H.useTransition()},K.version="19.1.0",K}var Bm;function Ls(){return Bm||(Bm=1,as.exports=Sg()),as.exports}var nn=Ls();const zs=Mp(nn);var ls={exports:{}},ei={},is={exports:{}},rs={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Vm;function zg(){return Vm||(Vm=1,function(s){function i(j,q){var Q=j.length;j.push(q);e:for(;0<Q;){var Se=Q-1>>>1,h=j[Se];if(0<f(h,q))j[Se]=q,j[Q]=h,Q=Se;else break e}}function o(j){return j.length===0?null:j[0]}function u(j){if(j.length===0)return null;var q=j[0],Q=j.pop();if(Q!==q){j[0]=Q;e:for(var Se=0,h=j.length,O=h>>>1;Se<O;){var U=2*(Se+1)-1,_=j[U],F=U+1,ce=j[F];if(0>f(_,Q))F<h&&0>f(ce,_)?(j[Se]=ce,j[F]=Q,Se=F):(j[Se]=_,j[U]=Q,Se=U);else if(F<h&&0>f(ce,Q))j[Se]=ce,j[F]=Q,Se=F;else break e}}return q}function f(j,q){var Q=j.sortIndex-q.sortIndex;return Q!==0?Q:j.id-q.id}if(s.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var m=performance;s.unstable_now=function(){return m.now()}}else{var g=Date,k=g.now();s.unstable_now=function(){return g.now()-k}}var w=[],b=[],M=1,L=null,Y=3,J=!1,I=!1,ie=!1,re=!1,Ue=typeof setTimeout=="function"?setTimeout:null,Me=typeof clearTimeout=="function"?clearTimeout:null,se=typeof setImmediate<"u"?setImmediate:null;function te(j){for(var q=o(b);q!==null;){if(q.callback===null)u(b);else if(q.startTime<=j)u(b),q.sortIndex=q.expirationTime,i(w,q);else break;q=o(b)}}function X(j){if(ie=!1,te(j),!I)if(o(w)!==null)I=!0,Ne||(Ne=!0,Ae());else{var q=o(b);q!==null&&tn(X,q.startTime-j)}}var Ne=!1,me=-1,ye=5,C=-1;function V(){return re?!0:!(s.unstable_now()-C<ye)}function oe(){if(re=!1,Ne){var j=s.unstable_now();C=j;var q=!0;try{e:{I=!1,ie&&(ie=!1,Me(me),me=-1),J=!0;var Q=Y;try{n:{for(te(j),L=o(w);L!==null&&!(L.expirationTime>j&&V());){var Se=L.callback;if(typeof Se=="function"){L.callback=null,Y=L.priorityLevel;var h=Se(L.expirationTime<=j);if(j=s.unstable_now(),typeof h=="function"){L.callback=h,te(j),q=!0;break n}L===o(w)&&u(w),te(j)}else u(w);L=o(w)}if(L!==null)q=!0;else{var O=o(b);O!==null&&tn(X,O.startTime-j),q=!1}}break e}finally{L=null,Y=Q,J=!1}q=void 0}}finally{q?Ae():Ne=!1}}}var Ae;if(typeof se=="function")Ae=function(){se(oe)};else if(typeof MessageChannel<"u"){var mn=new MessageChannel,$e=mn.port2;mn.port1.onmessage=oe,Ae=function(){$e.postMessage(null)}}else Ae=function(){Ue(oe,0)};function tn(j,q){me=Ue(function(){j(s.unstable_now())},q)}s.unstable_IdlePriority=5,s.unstable_ImmediatePriority=1,s.unstable_LowPriority=4,s.unstable_NormalPriority=3,s.unstable_Profiling=null,s.unstable_UserBlockingPriority=2,s.unstable_cancelCallback=function(j){j.callback=null},s.unstable_forceFrameRate=function(j){0>j||125<j?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):ye=0<j?Math.floor(1e3/j):5},s.unstable_getCurrentPriorityLevel=function(){return Y},s.unstable_next=function(j){switch(Y){case 1:case 2:case 3:var q=3;break;default:q=Y}var Q=Y;Y=q;try{return j()}finally{Y=Q}},s.unstable_requestPaint=function(){re=!0},s.unstable_runWithPriority=function(j,q){switch(j){case 1:case 2:case 3:case 4:case 5:break;default:j=3}var Q=Y;Y=j;try{return q()}finally{Y=Q}},s.unstable_scheduleCallback=function(j,q,Q){var Se=s.unstable_now();switch(typeof Q=="object"&&Q!==null?(Q=Q.delay,Q=typeof Q=="number"&&0<Q?Se+Q:Se):Q=Se,j){case 1:var h=-1;break;case 2:h=250;break;case 5:h=1073741823;break;case 4:h=1e4;break;default:h=5e3}return h=Q+h,j={id:M++,callback:q,priorityLevel:j,startTime:Q,expirationTime:h,sortIndex:-1},Q>Se?(j.sortIndex=Q,i(b,j),o(w)===null&&j===o(b)&&(ie?(Me(me),me=-1):ie=!0,tn(X,Q-Se))):(j.sortIndex=h,i(w,j),I||J||(I=!0,Ne||(Ne=!0,Ae()))),j},s.unstable_shouldYield=V,s.unstable_wrapCallback=function(j){var q=Y;return function(){var Q=Y;Y=q;try{return j.apply(this,arguments)}finally{Y=Q}}}}(rs)),rs}var Ym;function xg(){return Ym||(Ym=1,is.exports=zg()),is.exports}var os={exports:{}},rn={};/**
 * @license React
